...
module.exports = {
  apps: [
    ...
    {      name: "cron-calendar-sync",      cwd: "/opt/auctorum-systems/repo",      script: "npx",      args: "tsx scripts/cron-calendar-sync.ts",      cron_restart: "*/5 * * * *",      autorestart: false,      watch: false,      env: cronEnv,      log_date_format: "YYYY-MM-DD HH:mm:ss Z",      error_file: "/var/log/auctorum/cron-calendar-sync-error.log",      out_file: "/var/log/auctorum/cron-calendar-sync-out.log",      merge_logs: true,    },    {      name: "cron-smart-reminders",      cwd: "/opt/auctorum-systems/repo",      script: "npx",      args: "tsx scripts/cron-smart-reminders.ts",      cron_restart: "0 * * * *",      autorestart: false,      watch: false,      env: cronEnv,      log_date_format: "YYYY-MM-DD HH:mm:ss Z",      error_file: "/var/log/auctorum/cron-smart-reminders-error.log",      out_file: "/var/log/auctorum/cron-smart-reminders-out.log",      merge_logs: true,    },
  cron_restart: '0 4 * * *',
};
