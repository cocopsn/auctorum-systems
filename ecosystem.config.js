  ...
  apps: [
    ...
    },
    {
      ...
      env: {
        NODE_ENV: 'production',
        ...cronEnv,
        WHATSAPP_TOKEN: medEnv.WHATSAPP_TOKEN || '',
        WHATSAPP_PHONE_NUMBER_ID: medEnv.WHATSAPP_PHONE_NUMBER_ID || '',
        OPENAI_API_KEY: medEnv.OPENAI_API_KEY || webEnv.OPENAI_API_KEY || '',
      },
      log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
