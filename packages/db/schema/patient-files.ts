...
export const patientFiles = pgTable(
  "patient_files",
  {
    ...
    clinicalRecordId: uuid("clinical_record_id").references(() => clinicalRecords.id, { onDelete: "set null" }),
  ...
  (table) => ({
    ...
    byRecord: index("idx_patient_files_record").on(table.clinicalRecordId),
  }),
)
